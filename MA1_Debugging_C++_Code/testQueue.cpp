...
void testQueue::testIsEmpty()
{
    /*       Test ID: Empty Queue Check - EQC
            Unit: queue::isEmpty() 
    Description: test to determine if queue::isEmpty() returns correct bool value
        Test steps: 
    ...
    Expected result: queue has size 0; 1 is returned 
            Actual result: queue has size 0; 1 is returned 
            Status: passed 
    */ 
...
void testQueue::testEnqueue()
{
    ...
    Description: test to determine if queue::enqueue() returns correct bool value
        ...
        Test steps: 
        1.    Construct a queue object with size = 0
        2.    Invoke queue::enqueue(2)
        3.    Conditionally evaluate the value returned by queue::enqueue(2) 
        4.    Conditionally evaluate the value inserted into
                queue by queue::enqueue(2) 
    Test data: size = 0 
    Precondition: queue object has size = 0, peek() functions properly
    Postcondition: queue object is size = 1, item 2 is inserted to queue
    Expected result: queue is size = 1, item 2 inserted; true (1) is returned and peek() returns 2
    Actual result: queue is size = 1, item 2 inserted; true (1) is returned and peek() returns 2
            Status: passed 
    */ 
